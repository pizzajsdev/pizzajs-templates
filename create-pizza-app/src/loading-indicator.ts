...
import { color, reverse, sleep } from './utils'
...
const INDICATOR_FULL_FRAMES = [...LEADING_FRAMES, ...GRADIENT_COLORS, ...TRAILING_FRAMES, ...reverse(GRADIENT_COLORS)]
...
async function gradient(text: string, { stdin = process.stdin, stdout = process.stdout, noMotion = false } = {}) {
